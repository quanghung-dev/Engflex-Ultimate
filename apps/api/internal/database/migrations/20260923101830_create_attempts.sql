...
CREATE TABLE attempts (
    ...
    lesson_practice_id uuid REFERENCES lessons_practice (id) ON DELETE SET NULL,
    activity_id        uuid REFERENCES lesson_practice_activities (id) ON DELETE SET NULL,
...
CREATE INDEX idx_attempts_lesson_practice_id ON attempts (lesson_practice_id);
