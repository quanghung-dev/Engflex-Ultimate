...
const NAV_GROUPS = [
  {
    ...
    items: [
      { title: "Home", to: APP_ROUTES.HOME, icon: House },
      { title: "Lessons", to: APP_ROUTES.LESSONS, icon: BookOpen },
      { title: "Voice", to: APP_ROUTES.VOICE, icon: AudioWaveform },
    ],
  },
  {
    label: "Knowledge & review",
    items: [
      { title: "Vocabulary", to: APP_ROUTES.VOCABULARY, icon: BookmarkCheck },
    ],
  },
] as const;
  ...
  return (
    <div className="flex items-center gap-2.5 rounded-lg border border-sidebar-border bg-card p-2">
      ...
      <div className="flex min-w-0 flex-col leading-tight">
        ...
        <span className="text-[11px] text-muted-foreground">Learner</span>
      </div>
